...
// File: contracts/toonverse.sol
    ...
    string public BASE_URI ="https://fruittown.s3.us-east-2.amazonaws.com/json/"; //https://fruittown.s3.us-east-2.amazonaws.com/json/1.json
    string public BASE_EXTENSION = ".json";
    string public NOT_REVEALED_URI= "https://fruittown.s3.us-east-2.amazonaws.com/images/ftgbanner.png";
    ...
    //Devil Catz Wallet free mint --  check if wallet owns cats, have they minted yet? mint and  add to ownerMinted. 
        function catOwnerFreeMint() public payable  mintChecks(ownerMintAmount)  {
            require(ownerMintAmount<= MAX_MINT_AMOUNT, "Can not exceed max mint amount.");
            if(msg.sender!= owner()){
            checkIfPaused();
            require(msg.value >= MintCostEth * ownerMintAmount, "Not Enough Eth Sent.");
    ...
    function mintForEth(uint256 _mintAmount) public payable  mintChecks(_mintAmount)  {
            require(_mintAmount<= MAX_MINT_AMOUNT, "Can not exceed max mint amount.");
            if(msg.sender!= owner()){
            checkIfPaused();
            require(msg.value >= MintCostEth * _mintAmount, "Not Enough Eth Sent.");
