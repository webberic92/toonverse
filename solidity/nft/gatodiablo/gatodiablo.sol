...
contract GatoDiablo is ERC721A, Ownable,DefaultOperatorFilterer {
    ...
    uint256 public discountedCost = 0.02 ether; // only 1 cat staked == unlimited .02 mints.  // unstaked cats == 2 @ .02


    uint256 public publicMintCost = 0.04 ether; 
    uint256 public toonMintCost = 100;// $TOON only 350 mints can be used with 100 toon and 2 per wallet so max 200 TOON per wallet
    ...
    address public ARTIST = 0x76e500042F0d958d0cC9EF4EE67eB605dD104B10;//Ketih //DC's owner 0xe09E300ED2a79F258e53E35d6FB6134e3C9Ed56c // DCs owner aux 0x76e500042F0d958d0cC9EF4EE67eB605dD104B10
    ...
    constructor() ERC721A("GatoDiablo", "GTD", MAX_SUPPLY, MAX_MINT_AMOUNT) {
        $toon = $TOON(0xc9Be0d23f81c7ad475DCF6359CbD5b0e6083163b);
        devilCatz = ERC721A(0x2181eF3E8Fe13216FADf664334a8368eeba9A8D9);
        _safeMint(ARTIST, 50);
