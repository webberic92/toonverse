(function (global, factory) {
    ...
    var CarouselComponent = /** @class */ (function () {
        ...
        CarouselComponent.prototype.nextSlide = function (force) {
            ...
            var direction = Direction$1.NEXT;
        ...
        CarouselComponent.prototype.previousSlide = function (force) {
            ...
            var videoList = this.el.nativeElement.getElementsByTagName('video');
            var direction = Direction$1.PREV;
            var indexel = this.findNextSlideIndex(direction, force);
            if (videoList.length > 0) {
                // Check for video carousel
                for (var i = 0; i < videoList.length; i++) {
            ...
            if (this.animationEnd) {
                ...
                if (this.isBrowser) {
                    setTimeout(function () {
                        ...
                        _this.renderer.setStyle(previous, 'display', 'none');
                        ...
                        if (direction === 1) {
                            ...
                            _this.activeSlideChange.emit({
                                direction: goToIndex < _this.activeSlide ? 'Prev' : 'Next',
    ...
    ***************************************************************************** */
    ...
    var Utils = /** @class */ (function () {
        ...
        Utils.prototype.getCoords = function (elem) {
            ...
            var body = document$2.body;
            var docEl = document$2.documentElement;
            var scrollTop = win$1.pageYOffset || docEl.scrollTop || body.scrollTop;
            var scrollLeft = win$1.pageXOffset || docEl.scrollLeft || body.scrollLeft;
       ...
       */
        ...
        ModalDirective.prototype.hideModal = function () {
            ...
            this.showBackdrop(function () {
                if (!_this.isNested) {
                    if (document$2 && document$2.body) {
                        _this._renderer.removeClass(document$2.body, ClassName.OPEN);
                    }
                }
    ...
    var ModalContainerComponent = /** @class */ (function () {
        ...
        ModalContainerComponent.prototype.ngOnInit = function () {
            ...
            if ((window &&
                ...
                setTimeout(function () {
                    _this.isShown = true;
                    _this._renderer.addClass(_this._element.nativeElement, isBs3$1() ? ClassName.IN : ClassName.SHOW);
    ...
    var MdbTableScrollDirective = /** @class */ (function () {
        ...
        Object.defineProperty(MdbTableScrollDirective.prototype, "maxHeight", {
            get: function () {
        ...
        Object.defineProperty(MdbTableScrollDirective.prototype, "maxWidth", {
            get: function () {
    ...
    MdbTableService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function MdbTableService_Factory() { return new MdbTableService(); }, token: MdbTableService, providedIn: "root" });
    ...
    var StickyHeaderDirective = /** @class */ (function () {
        ...
        StickyHeaderDirective.prototype.ngAfterViewInit = function () {
            var _this = this;
            var scroll$ = rxjs.fromEvent(win$1, 'scroll').pipe(operators.throttleTime(10), operators.map(function () { return win$1.pageYOffset; }), operators.pairwise(), operators.map(function (_a) {
                var _b = __read(_a, 2), y1 = _b[0], y2 = _b[1];
                return (y2 < y1 ? Direction.Up : Direction.Down);
            }), operators.distinctUntilChanged(), operators.share());
            this.scrollUp$ = scroll$.pipe(operators.filter(function (direction) { return direction === Direction.Up; }));
            this.scrollDown$ = scroll$.pipe(operators.filter(function (direction) { return direction === Direction.Down; }));
